...
export async function battery() {
  ...
  try {
    ...
    await page.goto("https://solarshop.co.ke/buy-solar-batteries-in-kenya/", {
    ...
    fs.writeFileSync("battery.json", JSON.stringify(jsonData, null, 2));
    console.log("✅ Data saved to battery.json");
