...
export async function outdoorLights() {
  ...
  try {
    ...
    await page.goto("https://solarshop.co.ke/solar-outdoor-lights/", {
    ...
    const urlsToScrape = productUrls.slice(0, 142);
    ...
    fs.writeFileSync("lights.json", JSON.stringify(jsonData, null, 2));
    console.log("✅ Data saved to lights.json");
